        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="<?= base_url('home/ManagelistView') ?>"><i class="fa fa-folder-o"></i> <span>Faktur Manager</span></a></li>
                </ul>
                <!-- /.sidebar-menu -->
            </section>
            <!-- /.sidebar -->
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select width="100%" class="form-control select2" id="texttahun">
                                <option value="null">-</option>
                                <?php
                                $query = $this->db->query('SELECT tahun_pajak from header_faktur GROUP BY tahun_pajak ORDER BY tahun_pajak DESC');
                                foreach ($query->result() as $dt) {
                                    ?>
                                    <option value="<?php echo $dt->tahun_pajak; ?>"><?php echo $dt->tahun_pajak; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <!-- <input style="margin-left:-17px;width:170px" type="text" class="form-control" id="yearPicker"> -->
                            <select width="100%" class="form-control select2" id="textmassa">
                                <option value="null">-</option>
                                <?php
                                $query = $this->db->query('SELECT masa_pajak from header_faktur GROUP BY masa_pajak ORDER BY masa_pajak DESC');
                                foreach ($query->result() as $dt) {
                                    ?>
                                    <option value="<?php echo $dt->masa_pajak; ?>"><?php echo $dt->masa_pajak; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Suplier</label>
                            <!-- <input style="margin-left:-17px;width:170px" type="text" class="form-control" id="yearPicker"> -->
                            <select width="100%" class="form-control select2" id="textsuplier">
                                <option value="null">-</option>
                                <?php
                                $query = $this->db->query('SELECT nama_pbf from header_faktur GROUP BY nama_pbf');
                                foreach ($query->result() as $dt) {
                                    ?>
                                    <option value="<?php echo $dt->nama_pbf; ?>"><?php echo $dt->nama_pbf; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <button class="btn btn-primary" id="export" style="width:170px;"><i class="fa fa-download"></i> Export To Csv</button>
                        <input type="hidden" id="apa">
                    </div>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li id="tb1" class="active"><a href="#tab_1" data-toggle="tab">Belum Di Export</a></li>
                                <li id="tb2"><a href="#tab_2" data-toggle="tab">Sudah Di Export</a></li>
                            </ul>
        ...
        <script>
            ...
            $(function() {
                ...
                var table = $("#example1").DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        "url": "<?php echo base_url() . 'home/getAllFakturNonExported' ?>",
                        "type": "POST",
                        "data": function(data) {
                            data.tahun = $('#texttahun').val();
                            data.massa = $('#textmassa').val();
                            data.suplier = $('#textsuplier').val();
                ...
                var table2 = $("#example2").DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        "url": "<?php echo base_url() . 'home/getAllFakturExported' ?>",
                        "type": "POST",
                        "data": function(data) {
                            data.tahun = $('#texttahun').val();
                            data.massa = $('#textmassa').val();
                ...
                $('#texttahun').change(function() {
                    $("#example1").DataTable().ajax.reload();
                    $("#example2").DataTable().ajax.reload();
                });

                $('#textmassa').change(function() {
                    $("#example1").DataTable().ajax.reload();
                    $("#example2").DataTable().ajax.reload();
                });

                $('#textsuplier').change(function() {
                    $("#example1").DataTable().ajax.reload();
                    $("#example2").DataTable().ajax.reload();
                });
                ...
                $('#export').click(function() {
                    var tahun = $('#texttahun').val();
                    var massa = $('#textmassa').val();
                    var spl = $('#textsuplier').val();
                    var ex = $('#apa').val();

                    window.location.assign("<?php echo base_url() . 'home/exportFilter/' ?>" + tahun + '/' + massa + '/' + spl + '/' + ex);
